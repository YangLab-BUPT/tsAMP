...
def train_model(X_train, y_train, X_val, y_val, model, device, num_epochs=100, learning_rate=0.00005, batch_size=32, results_file='training.csv'):
    ...
    for epoch in tqdm(range(num_epochs), desc="Training Epochs", unit="epoch"):
        ...
        for i in train_loader:
            ...
            y_batch = y_train[start_idx:end_idx].to(device).unsqueeze(1)  
...
positive_dir = '/tsAMP/data/tsAMP-I/train_amp'  #The feature extraction needs to be carried out using esm1v and the resulting file should be saved as.pt.
excel_file = '/tsAMP/data/tsAMP-I/train_amp.xlsx'  
negative_dir = '/tsAMP/data/tsAMP-I/negative_train1'
excel_file2 = '/tsAMP/data/tsAMP-I/negative_train1.xlsx' 


data_loader = DataLoader(positive_dir, negative_dir, excel_file, excel_file2)
